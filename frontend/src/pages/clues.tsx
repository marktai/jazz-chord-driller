...
class Clues extends React.Component<CluesProps, CluesState> {
  ...
  renderCard(i: number) {
    ...
    return (
      <div className="jazz_chords-card clue-card">
      ...
      <Col xs={12} lg={8}>
        ...
        </Row>
        {
          this.state.game?.clues != null ?
            <Row>
              <Col>Clues submitted at {this.state.game?.last_updated_time}! To guess, go to <a href={`http://jazz_chords.marktai.com/games/${this.props.id}/guess`}>http://jazz_chords.marktai.com/games/{this.props.id}/guess</a>
              </Col>
            </Row>
          : null
        }
